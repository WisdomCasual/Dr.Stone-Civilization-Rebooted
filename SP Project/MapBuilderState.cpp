			...
			for (int k = 0; k < 2; k++)
				for (int l = 0; l < 2; l++) {
					...
					for (auto layer : tiles[i][j].layer) {
						if (!(tile_props[layer.second.z].properties[layer.second.x][layer.second.y].props & 1) && !(tile_props[layer.second.z].properties[layer.second.x][layer.second.y].props & 8) && !((layer.second.x >= 11 && layer.second.x <= 14) && layer.second.y == 12 && layer.second.z == 3)) {
